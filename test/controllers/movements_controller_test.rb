...
class MovementsControllerTest < ActionController::TestCase
  ...
  test "should create movement" do
    assert_difference('Movement.count') do
      post :create, movement: { anno: @movement.anno, conto: @movement.conto, importo: @movement.importo, livello: @movement.livello, mese: @movement.mese, tipo_conto: @movement.tipo_conto, voce: @movement.voce }
    end
  ...
  test "should update movement" do
    patch :update, id: @movement, movement: { anno: @movement.anno, conto: @movement.conto, importo: @movement.importo, livello: @movement.livello, mese: @movement.mese, tipo_conto: @movement.tipo_conto, voce: @movement.voce }
    assert_redirected_to movement_path(assigns(:movement))
  end
